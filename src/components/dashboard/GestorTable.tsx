    ...
    >
      <div className="flex items-center justify-between border-b p-5">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Desempenho consolidado por gestor de loja</p>
        </div>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {gestores.map((g, i) => {
              ...
              const pct = Math.min(100, (g.taxa / (meta * 2)) * 100);
              return (
                <tr
                  key={g.gestor}
                ...
                >
                  ...
                  <td className="px-4 py-3 text-right">
                    ...
                    >
                      {g.taxa - meta > 0 ? "+" : ""}
                      {(g.taxa - meta).toLocaleString("pt-BR", { maximumFractionDigits: 1 })} p.p.
                    </span>
                  </td>
                </tr>
              );
